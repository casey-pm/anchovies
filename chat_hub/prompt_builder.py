...
def build_task_prompt(
    ...
    parts.extend([
        ...
        "## When Complete",
        "",
        "1. **Write a task history entry:**",
        "   Create a file in `task_history/` (create the directory if needed) with your summary.",
        f"   Filename: `task_history/{persona}_<date>_<short-task-slug>.md`",
        "   Include: what you did, files created/modified, key decisions, any issues encountered.",
        "",
        ...
        "   ```",
        "",
        "4. **If another team member should work next** (according to the Director's plan),",
        "   include a handoff note in your Slack message telling Casey who should go next.",
        "   Example: 'Core module done. Next step per the plan: assign leo write unit tests for core.py'",
        "   Casey will type the assign command to spawn them.",
        "",
        "5. **Signal completion:**",
