...
def _save_project_spec(project: str, director_response: str, original_request: str) -> None:
    ...
    This ensures every developer who spawns can read the spec.
    The spec is overwritten each time Marcus plans for the same project.
    """
    try:
...
"""
        ...
        logger.info(f"[ChatHub] Saved project spec to {spec_path}")
        ...
        logger.error(f"[ChatHub] Failed to save project spec: {e}")
